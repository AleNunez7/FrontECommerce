      ...
      <div className="container mt-5">
        <div className="row">
          ...
          <div className="col-sm-6">
            ...
            placeat, accusantium asperiores voluptas beatae non recusandae
            veniam? Totam, esse, neque nostrum, dolore explicabo provident quas
            tempora at cupiditate ex animi.
