  ...
  return (
    <>
      ...
      <div className="container">
        <div className="row d-flex justify-content-between text-center">
          ...
          <div className="col-md-4 text-center mt-5 mb-5">
            ...
            <Link
              ...
              to={{
                pathname:
                  "https://www.linkedin.com/in/santiago-quintela-delfino-73a6bb132/",
              }}
              target="_blank"
            >
              <i className="linkedinColor fab fa-linkedin-in"></i>
        ...
        <hr />
        <h1 className="fw-light mt-5 mb-5 text-center">
          COMO INGRESAR A ADMINISTRADOR
        </h1>
        <div className="text-start fs-4 mb-5">
          <p>
            Link para ingresar a la vista de Administrador: <br />{" "}
            <a className="text-dark" href="https://admin-shohack.vercel.app">
              https://admin-shohack.vercel.app
            </a>
            <br />
            En esta sección se podrá leer, crear, modificar y eliminar usuarios,
            productos y roles.
            <br /> También se podrán ver las ordenes realizadas por cada
            usuario. <br />
        ...
        <div className="container  d-flex justify-content-center">
          <div className="row">
            <div className="col me-5 fw-bold fs-4">
              React Js <br /> Node.js <br /> MongoDB <br /> Express js <br />{" "}
              Mongoose
            </div>
